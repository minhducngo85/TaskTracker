...
INSERT INTO task (title, description, status, priority, assigned_to, created_At, updated_At, due_Date)
VALUES ('My work in dashbaord', 'Show my work: due today, due in 7 days, and overdue', 'TODO', 'HIGH', 'admin', '2026-04-23 12:10:00', '2026-04-23 12:10:00', '2026-05-30 09:10:25');
INSERT INTO task_tags (task_id, tag)
VALUES 
((SELECT MAX(id) FROM task), 'paginator'),
((SELECT MAX(id) FROM task), 'comment'),
